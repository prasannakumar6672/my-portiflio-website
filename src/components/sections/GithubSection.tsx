...
import { GitBranch, Star, GitFork, BookOpen, Activity, Code, Layers } from "lucide-react";
                ...
                <div className="grid lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-8 space-y-6">
                        ...
                        <Card className="border-slate-200 dark:border-white/5 bg-slate-50/[0.2] dark:bg-white/[0.01] p-5">
                            <div className="space-y-4">
                                <div className="flex items-center justify-between text-xs text-slate-400 dark:text-slate-500 font-mono font-bold">
                                ...
                                {/* Legend */}
                                <div className="flex items-center justify-end gap-1.5 text-[10px] text-slate-400 dark:text-slate-500 font-mono font-bold pt-2 border-t border-slate-100 dark:border-white/[0.04]">
                                    <span>Less</span>
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        ...
                        <Card className="border-slate-200 dark:border-white/5 bg-slate-50/[0.2] dark:bg-white/[0.01] p-4 space-y-4">
                            <span className="text-[10px] font-mono font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest block border-b border-slate-100 dark:border-white/[0.04] pb-2">
                                Top Languages
                            </span>
                            <div className="space-y-3">
                                {[

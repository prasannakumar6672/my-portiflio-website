...
import { Github, ExternalLink, ArrowUpRight, Check, AlertTriangle, Cpu, Lightbulb, Compass, Code, Bot } from "lucide-react";
...
const getFeaturedBadge = (id: string) => {
    switch (id) {
        case "water-body-encroachment":
            return { text: "SIH Finalist", color: "border-amber-500/30 text-amber-500 bg-amber-500/5" };
        case "road-damage-detection":
...
// ─── Tabbed Project Detail Showcase ──────────────────────────────────────────
            ...
            <AnimatePresence mode="wait">
                {activeTab === "overview" ? (
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div className="space-y-2.5">
                                <h4 className="text-[10px] font-mono font-black uppercase tracking-widest text-red-650 dark:text-red-500 flex items-center gap-1.5">
                            ...
                            <div className="space-y-2.5">
                                <h4 className="text-[10px] font-mono font-black uppercase tracking-widest text-purple-650 dark:text-purple-500 flex items-center gap-1.5">
            ...
            <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
                ...
                <div className="mb-14 flex flex-col sm:flex-row sm:items-end justify-between gap-6">
                    <div className="space-y-3">
                        <span className="text-xs font-mono font-bold tracking-[0.25em] text-accent uppercase block">// selected accomplishments</span>

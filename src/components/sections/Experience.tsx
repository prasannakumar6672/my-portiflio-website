...
const CardContent = ({ exp }: { exp: ExperienceType }) => {
            ...
            <div className="relative z-10 space-y-4">
                ...
                <div className="pt-3.5 border-t border-slate-200 dark:border-white/[0.05] flex items-center justify-between gap-3">
                    {exp.certificateUrl ? (
                        ...
                        <div className="text-[10px] text-slate-400 dark:text-slate-550 font-mono tracking-wide">
                    ...
                    <div 
                        className={`w-10 h-10 rounded-full bg-white dark:bg-[#050505] border-2 flex items-center justify-center transition-all duration-300 z-10 shadow-md ${
                            exp.active 
                                ...
                                : "border-slate-200 dark:border-white/10 text-slate-400 dark:text-slate-550 hover:border-accent hover:text-accent"
                        }`}
                    >

...
import { Award, Code, GraduationCap, X, ExternalLink, ShieldCheck, Sparkles, Calendar } from "lucide-react";
                                        ...
                                        <div className="flex items-center justify-between gap-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-[10px] text-slate-500 dark:text-slate-550 font-semibold">{item.issuer} • {item.date}</p>
                                                </div>
                                            </div>
                                            {item.link && (
                                                <a
